        ...
        <form @submit.prevent="handleSubmit" class="space-y-6">
          <div class="space-y-5">
            ...
            <div class="group">
              ...
              <p v-if="errors.name" class="text-red-500 text-sm mt-2 animate-fadeIn">{{ errors.name }}</p>
            </div>
              ...
              <div class="mt-2 space-y-1">
                <div class="flex items-center space-x-2">
                  <div class="flex space-x-1">
                    <div :class="passwordStrength >= 1 ? 'bg-red-400' : 'bg-gray-200'" class="h-1 w-6 rounded-full transition-colors"></div>
                    <div :class="passwordStrength >= 2 ? 'bg-yellow-400' : 'bg-gray-200'" class="h-1 w-6 rounded-full transition-colors"></div>
                    <div :class="passwordStrength >= 3 ? 'bg-green-400' : 'bg-gray-200'" class="h-1 w-6 rounded-full transition-colors"></div>
                  </div>
                  <span class="text-xs text-gray-500">{{ passwordStrengthText }}</span>
                </div>
                <p class="text-xs text-gray-500">Must contain uppercase, lowercase, number and 8+ characters</p>
              </div>
            ...
            <div class="group">
              ...
              <p v-if="errors.confirmPassword" class="text-red-500 text-sm mt-2 animate-fadeIn">{{ errors.confirmPassword }}</p>
            </div>
          </div>
          ...
          <div class="flex items-start space-x-3">
            ...
            <label for="agree-terms" class="text-sm text-gray-700 leading-relaxed">
              ...
              <BaseButton 
                ...
                as="a" 
                href="#"
                class="inline p-0 h-auto font-medium"
              >
                Terms of Service
              </BaseButton> 
              and 
...
const handleSubmit = async () => {
  ...
  try {
    ...
    console.log('Registration:', formState)
    ...
    if (err.message.includes('email')) {
      ...
      errors.name = 'Registration failed. Please try again.'
    }
  } finally {
    loading.value = false
  }
